...
class DockerOperations
  def self.set_timeout
    timeout = OmnibusGitlab::Util.get_env('DOCKER_TIMEOUT') || 1200
  ...
  def self.authenticate(username = OmnibusGitlab::Util.get_env('DOCKERHUB_USERNAME'), password = OmnibusGitlab::Util.get_env('DOCKERHUB_PASSWORD'), serveraddress = "")
