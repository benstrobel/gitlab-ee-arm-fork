...
class PackageRepository
  ...
  def target
    # Override
    return OmnibusGitlab::Util.get_env('PACKAGECLOUD_REPO') if OmnibusGitlab::Util.get_env('PACKAGECLOUD_REPO') && !OmnibusGitlab::Util.get_env('PACKAGECLOUD_REPO').empty?
    # Repository for raspberry pi
    return OmnibusGitlab::Util.get_env('RASPBERRY_REPO') if OmnibusGitlab::Util.get_env('RASPBERRY_REPO') && !OmnibusGitlab::Util.get_env('RASPBERRY_REPO').empty?
  ...
  def upload_user
    OmnibusGitlab::Util.get_env('PACKAGECLOUD_USER') if OmnibusGitlab::Util.get_env('PACKAGECLOUD_USER') && !OmnibusGitlab::Util.get_env('PACKAGECLOUD_USER').empty?
  end
