...
class PackageSizeCheck
  CE_MAX_SIZE_MB = OmnibusGitlab::Util.get_env('CE_MAX_SIZE_MB')&.to_i || 950
  EE_MAX_SIZE_MB = OmnibusGitlab::Util.get_env('EE_MAX_SIZE_MB')&.to_i || 1000
  ALERT_ENDPOINT = OmnibusGitlab::Util.get_env('PACKAGE_SIZE_ALERT_ENDPOINT')
  ALERT_TOKEN = OmnibusGitlab::Util.get_env('PACKAGE_SIZE_ALERT_TOKEN')
  ...
  class << self
    ...
    def payload(package_size, permitted_size)
      ...
      # alerts will be grouped together.
      {
        ...
        pipeline: OmnibusGitlab::Util.get_env('CI_PIPELINE_URL'),
