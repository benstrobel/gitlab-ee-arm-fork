...
namespace :qa do
  ...
  task :build do
    ...
    qa_build_target = OmnibusGitlab::Util.get_env('QA_BUILD_TARGET') || edition_build_target
    OmnibusGitlab::Util.section('qa:build') do
  ...
  namespace :copy do
    ...
    task :nightly do
      OmnibusGitlab::Util.section('qa:copy:nightly') do
    ...
    task :stable do
      OmnibusGitlab::Util.section('qa:copy:stable') do
    ...
    task :rc do
      OmnibusGitlab::Util.section('qa:copy:rc') do
    ...
    task :latest do
      OmnibusGitlab::Util.section('qa:copy:latest') do
  ...
  namespace :push do
    ...
    task :staging do
      OmnibusGitlab::Util.section('qa:push:staging') do
    ...
    task :stable do
      OmnibusGitlab::Util.section('qa:push:stable') do
    ...
    task :rc do
      OmnibusGitlab::Util.section('qa:push:rc') do
    ...
    task :nightly do
      OmnibusGitlab::Util.section('qa:push:nightly') do
    ...
    task :latest do
      OmnibusGitlab::Util.section('qa:push:latest') do
  ...
  task :test_letsencrypt do
    OmnibusGitlab::Util.section('qa:test_letsencrypt') do
      OmnibusGitlab::Util.set_env_if_missing('CI_REGISTRY_IMAGE', 'registry.gitlab.com/gitlab-org/build/omnibus-gitlab-mirror')
  ...
  namespace :rat do
    ...
    task :nightly do
      OmnibusGitlab::Util.section('qa:rat:validate') do
