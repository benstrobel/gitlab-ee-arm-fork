require 'spec_helper'
require 'omnibus_gitlab/build/info'
require 'omnibus_gitlab/build/gitlab_image'
...
RSpec.describe Build::Info::Package do
  ...
  describe '.release_version' do
    before do
      allow(Build::Check).to receive(:on_tag?).and_return(true)
      allow_any_instance_of(Omnibus::BuildVersion).to receive(:semver).and_return('12.121.12')
      allow_any_instance_of(OmnibusGitlab::BuildIteration).to receive(:build_iteration).and_return('ce.1')
    end
