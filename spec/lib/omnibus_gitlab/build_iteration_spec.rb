require 'spec_helper'
require 'omnibus_gitlab/build_iteration'

RSpec.describe OmnibusGitlab::BuildIteration do
  describe :build_iteration do
    subject { OmnibusGitlab::BuildIteration.new(git_describe) }
    ...
    context 'not on a git tag' do
      subject { OmnibusGitlab::BuildIteration.new }
