require 'spec_helper'
require 'omnibus_gitlab/docker_operations'

RSpec.describe 'docker', type: :rake do
  before :all do
    Rake.application.rake_require 'omnibus_gitlab/tasks/docker_tasks'
  end
  ...
  describe 'docker:build:image' do
    ...
    it 'calls build command with correct parameters' do
      ...
      allow(File).to receive(:expand_path).and_return('/tmp/omnibus-gitlab/lib/omnibus_gitlab/tasks/docker_tasks.rake')
