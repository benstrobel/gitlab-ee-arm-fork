...
module Redis
  class << self
    ...
    def parse_redis_settings
      redis_helper = NewRedisHelper::GitlabRails.new(Gitlab[:node])
      if redis_helper.redis_server_over_tcp?
        ...
        parse_redis_daemon! unless redis_helper.has_sentinels?
      end
      ...
      Gitlab['redis']['master_password'] ||= Gitlab['redis']['password'] if redis_managed? && (redis_helper.sentinel_daemon_enabled? || redis_helper.redis_replica? || Gitlab['redis_master_role']['enable'])

      return unless redis_helper.sentinel_daemon_enabled? || redis_helper.redis_replica?
    ...
    def parse_redis_sentinel_settings
      return unless NewRedisHelper::GitlabRails.new(Gitlab[:node]).sentinel_daemon_enabled?
